...
export default function ConsumableLabelPrint() {
  ...
  const handlePrint = async () => {
    if (!consumableInfo)
      return showMessage("⚠️ Vui lòng nhập mã hợp lệ trước khi in!", "warning");
    if (!quantity || quantity <= 0)
      return showMessage("⚠️ Vui lòng nhập số lượng hợp lệ!", "warning");
      ...
      <div className="positions-section">
        ...
        <div className="test-print-section">
          <button
            ...
            disabled={!position.Y || !position.X}
          >
            Test Print
          </button>
        </div>
        ...
        <div className="basic-info-grid">
          ...
          <div className="info-row">
            <div className="info-pair">
              ...
              <div className="info-value">
                {consumableInfo ? consumableInfo.description : "-"}
              </div>
            </div>
            <div className="info-pair">
              <label>Expiration:</label>
              <div className="info-value">
                {consumableInfo ? consumableInfo.expiration : "-"}
              </div>
            </div>
          </div>
        </div>
