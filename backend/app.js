...
import machinesInputRoutes from "./src/routes/machinesInput.routes.js";
import currentDateRoutes from "./src/routes/utility.routes.js";
...
app.use("/api", machinesInputRoutes);
app.use("/api", currentDateRoutes);
